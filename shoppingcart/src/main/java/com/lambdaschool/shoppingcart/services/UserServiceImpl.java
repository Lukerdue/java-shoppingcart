    ...
    implements UserService
{
                                      ...
                                      ResourceNotFoundException
    {
        ...
        if(helperFunctions.isAuthorizedToMakeChange(currentUser.getUsername())){
            ...
            throw new ResourceNotFoundException(currentUser.getUsername() + " is not authorized to do that");
        }
    }
        ...
        long id)
    {
        if(helperFunctions.isAuthorizedToMakeChange(user.getUsername())) {
            ...
            throw new ResourceNotFoundException(user.getUsername() + "is not authorized to make this change");
        }
    }
